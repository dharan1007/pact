...
for (const file of ['engine.js', 'adapter.js', 'runtime.js', 'authority.js', 'api-authority.js', 'redis-store.js', 'canonical-store.js', 'durable-state.js', 'saga.js', 'rest-resource.js', 'http.js', 'http-handler.js', 'server-approval.js', 'server-runtime.js', 'provenance.js', 'webmcp.js', 'agent-bridge.js', 'persistence.js', 'orchestrator.js']) {
...
for (const file of ['agent-bridges.md', 'rest-provider.md']) {
  await cp(path.join(root, `docs/${file}`), path.join(dist, `docs/${file}`));
}
